# Source: https://pythonprogramming.altervista.org/draw-in-tkinters-canvas/
...
def addLine(event):
    ...
    lastx, lasty = event.x, event.y
    #print(lasty,lastx) -----> remove comment if you want to print all the position of the draw line
